...
aleae <file1> <file2> <trials> <time> <verbosity> [max_events]
...
[max_events] optionally sets a maximum number of reaction firings per trial; set to 7 for "after 7 steps"
